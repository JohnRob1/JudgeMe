...
class Credentials:
    ...
    def add_song_to_queue(self, song_uri):
        ...
        #query = "https://api.spotify.com/v1/me/player/seek?uris={}".format(song_uri)
        #query = "https://api.spotify.com/v1/me/player/queue".format(song_uri)

        #https://api.spotify.com/v1/me/player/queue?uri=spotify:track:4wqzOaLxiCRy2Et8tRyNSX
...
class Scope:
    ...
    def createScope(self):
        ...
        # user-modify-playback-state -> Controls queue status
